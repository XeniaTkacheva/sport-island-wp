<?php
/*
Template Name: Page Main Template
 */
get_header();
?>
                ...
                <section class="slider__slide stock">
                    <a href="blog.html" class="stock__link"
                       aria-label="Подробнее об акции скидка 20% на групповые занятия">
                        <img src="<?php echo esc_url(ORTI_IMG_DIR  ); ?>index__sales_pic1.jpg" alt=""
                             class="stock__thumb">
                ...
                <section class="slider__slide stock">
                    <a href="blog.html" class="stock__link"
                       aria-label="Подробнее об акции Скидка 30% на занятия с тренером">
                        <img src="<?php echo esc_url(ORTI_IMG_DIR); ?>index__sales_pic2.jpg" alt=""
                             class="stock__thumb">

<?php
/**
 * The template for displaying archive pages in category
 *
				...
				<ul class="posts-list">
					<li class="last-post">
						<a href="single.html" class="last-post__link" aria-label="Читать текст статьи: Растяжка от болей в мышцах">
							<figure class="last-post__thumb">
								<img src="<?php echo esc_url(ORTI_IMG_DIR); ?>blog__article_thmb1.jpg" alt="" class="last-post__img">
							</figure>
					...
					<li class="last-post">
						<a href="single.html" class="last-post__link" aria-label="Читать текст статьи: Бег помогает похудеть">
							<figure class="last-post__thumb">
								<img src="<?php echo esc_url(ORTI_IMG_DIR); ?>blog__article_thmb2.jpg" alt="" class="last-post__img">
							</figure>
							<div class="last-post__wrap">
					...
					<li class="last-post">
						<a href="single.html" class="last-post__link" aria-label="Читать текст статьи: Рельефный пресс">
							<figure class="last-post__thumb">
								<img src="<?php echo esc_url(ORTI_IMG_DIR); ?>blog__article_thmb3.jpg" alt="" class="last-post__img">
							</figure>
							<div class="last-post__wrap">
